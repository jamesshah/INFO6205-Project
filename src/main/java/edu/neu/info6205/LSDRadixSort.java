...
/**
 * Implementation sort of LSD Radix Sort algorithm to sort "Devanagari" strings.
 */
public class LSDRadixSort {

    private static final int ASCII_RANGE = 65356; // ascii range for unicode.
     ...
     * @param to     This is the ending index up until which sorting operation will be continued
     */
    private static void sort(String[] strArr, int from, int to) {
